...
export const CampaignContentCard = ({ buttonTop }: Props) => (
    <>
        ...
        <Section marginBottom="0">
                ...
                <Row marginBottom="29px">
                    <Column marginRight="26px">
                        <Row noWrap marginBottom="15px">
                            <Span color="#0F1642" fontSize="24px" fontWeight="normal" lineHeight="29px" opacity={0.5}>
                                Brand
                            </Span>
                        </Row>
                        <Row noWrap marginBottom="15px">
                ...
                <Row marginBottom="28px">
                    ...
                    <Column marginRight="0">
                        <Row alignCenter noWrap height="29px" marginBottom="15px">
                            <Span color="#0F1642" fontSize="14px" fontWeight="normal" lineHeight="17px" opacity={0.5}>
                                Apparel Accessories
                            </Span>
                        </Row>
                        <Row alignCenter noWrap height="29px" marginBottom="15px">
            ...
            <Column marginRight="0" maxWidth="400px">
                ...
                <Row marginBottom="20px">
                    ...
                    <Column marginRight="0">
                        <Row alignCenter noWrap marginBottom="15px">
                            <Span color="rgba(15, 22, 66, 0.5)" fontSize="24px" fontWeight="normal" lineHeight="29px">
                                1200
                            </Span>
                        </Row>
                        <Row alignCenter noWrap marginBottom="15px">
                ...
                <Row marginBottom="35px">
                    ...
                    <Column marginRight="0">
                        <Row noWrap marginBottom="10px">
                            <Span color="rgba(15, 22, 66, 0.5)" fontSize="18px" fontWeight="normal" lineHeight="22px">
                                10%
                            </Span>
                        </Row>
                        <Row noWrap marginBottom="10px">
                ...
                <Row marginBottom="42px">
                    <Column marginRight="10px">
                        <Row noWrap marginBottom="15px">
                            <Span color="rgba(15, 22, 66, 0.51)" fontSize="24px" fontWeight="normal" lineHeight="29px">
                                Like
                            </Span>
                        </Row>
                        <Row noWrap marginBottom="15px">
                    ...
                    <Column marginRight="0">
                        ...
                        <Row alignCenter noWrap marginBottom="15px">
                            ...
                            <Span color={successColor} fontSize="14px" fontWeight="normal" lineHeight="17px">
                                &#160; +2.7
                            </Span>
                        </Row>
                        <Row alignCenter noWrap marginBottom="15px">

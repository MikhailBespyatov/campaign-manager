...
import {
    ...
    testArray
} from 'components/common/tables/CampaignTableOldVersion/constants';
import {
    LegendaryTableColumn,
    LegendaryTableRow,
    TableColumn,
    TableRow
} from 'components/common/tables/CampaignTableOldVersion/styles';
...
export const CampaignTableOldVersion = () => (
